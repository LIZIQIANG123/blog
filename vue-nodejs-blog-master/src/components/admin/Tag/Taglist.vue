<template>
  <div class="allArticles">
    <div class="head">标签管理</div>
    <div class="content">
      <button class="new" @click="goNew">添加新标签</button>
      <table width="100%">
        <thead>
          <tr>
            <th>链接名</th>
...
export default {
  ...
  methods: {
    ...
    goModify(passage) {
      let id = passage.id;
      this.$router.push({ path: "Tag/modify/" + id });
    },
    goNew() {
      this.$router.push({ path: "Tag/modify/" });
    },
