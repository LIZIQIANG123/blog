<template>
  <div class="allArticle">
    ...
    <div class="article" v-for="(passage,index) in passages" :key="index" >
      <div class="title">
        <h1>
          <router-link :to="{name:'articles',params:{articleId:passage.id}}">{{passage.title}}</router-link>
        </h1>
        <div class="time">
      ...
      <div class="content">
        ...
        <!--	target="_blank"-->
        <span>
          <router-link :to="{name:'articles',params:{articleId:passage.id}}">更多>></router-link>
        </span>
        <hr>
        <div class="bottom">
          <div class="bottomTag">
            ...
            <div
              class="tag"
              v-for="(tag,index) in passage.tags"
              :key="index"
              v-if="tag"
              @click="findTag(tag)"
            >
